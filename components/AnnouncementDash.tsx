  ...
  return (
    <div>
      <div className="card card-border items-center bg-info m-4">
        <div className="card-title text-info-content border-b-2 border-info-content w-full mt-2 items-center justify-center">
          <h1 className="font-bold">ANNOUNCEMENTS</h1>
        </div>

        <div className="grid md:grid-cols-3 h-full card-body text-info-content">
          <div className="md:border-r-1 border-b-1 md:border-b-0 text-start col-span-1">
            
            <h2 className="font-bold">Notes From the Executive Board:</h2>
            <br />
            <p>Dear Alumni,</p>
            <br />
            <p>
